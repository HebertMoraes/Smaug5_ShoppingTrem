...
public class RefreshProductsValues : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //preço de venda
            salesPriceCandy.GetComponent<TMPro.TextMeshProUGUI>().text = "Revenda:$" + GameProductsBalanceVariables.sellPriceCandy.ToString();

            salesPriceChoco.GetComponent<TMPro.TextMeshProUGUI>().text = "Revenda:$" + GameProductsBalanceVariables.sellPriceChoco.ToString();

            salesPriceFone.GetComponent<TMPro.TextMeshProUGUI>().text = "Revenda:$" + GameProductsBalanceVariables.sellPriceFone.ToString();
        }
        else if (VariablesSave.translate == false)
        {
            //preço de venda
            salesPriceCandy.GetComponent<TMPro.TextMeshProUGUI>().text = "Sell for:$" + GameProductsBalanceVariables.sellPriceCandy.ToString();

            salesPriceChoco.GetComponent<TMPro.TextMeshProUGUI>().text = "Sell for:$" + GameProductsBalanceVariables.sellPriceChoco.ToString();

            salesPriceFone.GetComponent<TMPro.TextMeshProUGUI>().text = "Sell for:$" + GameProductsBalanceVariables.sellPriceFone.ToString();
        }
    }
}
